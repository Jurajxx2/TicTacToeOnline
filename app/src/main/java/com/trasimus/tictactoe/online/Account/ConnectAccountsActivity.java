                 ...
                 .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                     ...
                     public void onComplete(@NonNull Task<AuthResult> task) {
                         if (task.isSuccessful()) {
                             ...
                             Toast.makeText(ConnectAccountsActivity.this, "Authentication failed " + task.getResult().toString(),
                     ...
                     public void onComplete(@NonNull Task<AuthResult> task) {
                         if (task.isSuccessful()) {
                            ...
                            // launchAccountActivity();
                             ...
                             // If sign in fails, display a message to the user.
                             Toast.makeText(ConnectAccountsActivity.this, "Error while signing in", Toast.LENGTH_SHORT).show();
                         }
         ...
         mAuth.signInWithEmailAndPassword(email, password)
                 .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                     ...
                     public void onComplete(@NonNull Task<AuthResult> task) {
                         ...
                         if (!task.isSuccessful()) {
                             Toast.makeText(ConnectAccountsActivity.this, "Login error: wrong username or password", Toast.LENGTH_SHORT).show();
                         } else {
